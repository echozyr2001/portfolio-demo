...
# Content`,
	...
	describe("utility methods", () => {
		it("should generate slug from filename", async () => {
			...
			const generateSlugFromFilename = (service as any)
				.generateSlugFromFilename;

			expect(generateSlugFromFilename("test-post.mdx")).toBe("test-post");
			expect(generateSlugFromFilename("My Great Post.md")).toBe(
				"my-great-post",
			);
			expect(generateSlugFromFilename("post_with_underscores.mdx")).toBe(
		...
		it("should generate slug from title", async () => {
			...
			expect(generateSlugFromTitle("Post with Special Characters!@#")).toBe(
