...
import { MDXRenderer, MDXImage, CodeBlock, Callout, ImageGallery, MDXErrorBoundary } from '@/components/mdx';
...
describe('MDX Components', () => {
  ...
  describe('MDXRenderer', () => {
    ...
    it('applies custom className', () => {
      render(<MDXRenderer mdxSource={mockMDXSource} className="custom-class" />);
    ...
    it('can disable error boundary', () => {
      render(<MDXRenderer mdxSource={mockMDXSource} enableErrorBoundary={false} />);
      expect(screen.getByTestId('mdx-content')).toBeInTheDocument();
    });
  });
