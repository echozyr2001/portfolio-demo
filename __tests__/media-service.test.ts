...
describe('MediaService', () => {
  ...
  describe('Image Optimization', () => {
    it('should optimize JPEG images', async () => {
      const result = await (mediaService as any).optimizeImage(testImageBuffer, 'image/jpeg');
    ...
    it('should handle SVG files without processing', async () => {
      ...
      const result = await (mediaService as any).optimizeImage(svgBuffer, 'image/svg+xml');
    ...
    it('should resize large images', async () => {
      ...
      const result = await (mediaService as any).optimizeImage(largeImageBuffer, 'image/jpeg');
  ...
  describe('Dimension Calculations', () => {
    it('should maintain aspect ratio when resizing', () => {
      const result = (mediaService as any).calculateDimensions(1600, 900, 800, 600);
    ...
    it('should not upscale small images', () => {
      const result = (mediaService as any).calculateDimensions(400, 300, 1920, 1080);
    ...
    it('should handle portrait images correctly', () => {
      const result = (mediaService as any).calculateDimensions(900, 1600, 800, 600);
  ...
  describe('File Extension Handling', () => {
    it('should extract correct file extensions', () => {
      ...
      expect((mediaService as any).getFileExtension('animation.gif')).toBe('gif');
    ...
    it('should handle multiple dots in filename', () => {
      expect((mediaService as any).getFileExtension('my.image.file.png')).toBe('png');
    });
  });

  describe('Blurhash Generation', () => {
    it('should generate valid blurhash', async () => {
      const blurhash = await (mediaService as any).generateBlurhash(testImageBuffer);
    ...
    it('should return default blurhash on error', async () => {
      ...
      const blurhash = await (mediaService as any).generateBlurhash(invalidBuffer);
