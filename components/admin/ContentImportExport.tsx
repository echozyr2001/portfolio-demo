...
export function ContentImportExport({ onImportComplete, onExportComplete }: ImportExportProps) {
  // Import state
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = response.headers.get("Content-Disposition")?.split("filename=")[1]?.replace(/"/g, "") || "content-export.zip";
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleContentTypeChange("projects", e.target.checked)}
                />
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleStatusChange("archived", e.target.checked)}
                />
