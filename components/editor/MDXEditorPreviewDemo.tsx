...
export function MDXEditorPreviewDemo() {
  ...
  const [demoMode, setDemoMode] = useState<'integrated' | 'separate'>('integrated');
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
          <div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">编辑技巧：</h4>
          ...
          <div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">预览特性：</h4>
            <ul className="space-y-1 list-disc list-inside">
              <li>实时渲染MDX内容</li>
              <li>支持自定义React组件</li>
              <li>代码语法高亮</li>
