...
export function configureMDXLanguage(monaco: Monaco) {
  ...
  monaco.languages.setMonarchTokensProvider('mdx', {
    ...
    jsxKeywords: [
      ...
      'continue', 'switch', 'case', 'try', 'catch', 'finally', 'throw',
      'new', 'this', 'typeof', 'instanceof', 'in', 'of', 'class', 'extends',
      'super', 'static', 'public', 'private', 'protected', 'readonly',
      'abstract', 'interface', 'type', 'namespace', 'module', 'declare',
    ],
    ...
    tokenizer: {
      ...
      jsExpression: [
        ...
        [/\b(?:import|export|default|from|as|const|let|var|function|return|if|else|for|while|do|break|continue|switch|case|try|catch|finally|throw|new|this|typeof|instanceof|in|of|class|extends|super|static|public|private|protected|readonly|abstract|interface|type|namespace|module|declare)\b/, 'keyword'],
