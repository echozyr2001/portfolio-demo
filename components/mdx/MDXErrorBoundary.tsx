...
class MDXErrorHandler {
  ...
  static parseError(error: Error, errorInfo?: ErrorInfo): MDXError {
    ...
    // 检测MDX语法错误
    if (errorMessage.includes('Expected') || errorMessage.includes('Unexpected')) {
      return {
        type: 'syntax',
        message: errorMessage,
        suggestion: 'Please check your MDX syntax. Make sure all JSX elements are properly closed and nested.',
        componentStack,
      };
    }
    ...
    if (errorMessage.includes('Element type is invalid') || 
      ...
      return {
        type: 'component',
        message: errorMessage,
        suggestion: 'This error is likely caused by a missing or incorrectly imported component in your MDX content.',
        componentStack,
      };
    }
    ...
    if (errorMessage.includes('Cannot read') || 
      ...
      return {
        type: 'runtime',
        message: errorMessage,
        suggestion: 'This appears to be a runtime error. Check if all variables and props are properly defined.',
        componentStack,
      };
    }
    ...
    return {
      type: 'unknown',
      message: errorMessage,
      suggestion: 'An unexpected error occurred while rendering the MDX content.',
      componentStack,
    };
  }
    ...
    <div className="my-8 p-6 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg">
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* 详细错误信息 */}
          {showDetails && (showDetailedError || process.env.NODE_ENV === 'development') && (
 ...
 * - 错误日志记录
 */
export class MDXErrorBoundary extends Component<MDXErrorBoundaryProps, ErrorBoundaryState> {
