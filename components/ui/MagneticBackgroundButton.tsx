...
export function MagneticBackgroundButton({
  ...
  return (
    <button
      ...
      ref={buttonRef}
      className={cn(
        "relative inline-flex items-center justify-center rounded-lg z-10 tracking-tight text-white/90 font-medium px-3 py-2 transition-colors",
        className
      )}
      {...props}
    >
      <span
        className={cn(
          ...
          "before:bg-white/10 hover:before:bg-white/15",
