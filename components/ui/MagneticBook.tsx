  ...
  return (
    ...
    >
      <div
        ...
        className={`relative [transform-style:preserve-3d] ${
          isStatic
            ...
            : "[transform:rotateY(90deg)] group-hover:[transform:rotateY(30deg)]"
      ...
      >
        ...
        {/* Spine */}
        <div
          className={`absolute right-0 overflow-hidden size-full text-white flex flex-col justify-end p-6 bg-linear-to-tr ${gradient.from} ${gradient.to} ${radiusMap[radius]}`}
          style={{
            top: "3px",
            bottom: "3px",
            width: "48px",
