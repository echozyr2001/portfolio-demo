...
async function testAPIEndpointStructure() {
  ...
  for (const endpoint of endpoints) {
    ...
    try {
      ...
      if (content.includes("requireAuth") || content.includes("isAuthenticatedFromRequest")) {
  ...
  console.log(`  ✅ Found validation schemas in ${foundSchemas}/${endpoints.length} endpoints`);
